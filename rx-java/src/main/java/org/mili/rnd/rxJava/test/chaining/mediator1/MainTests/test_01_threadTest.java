...
package org.mili.rnd.rxJava.test.chaining.mediator1.MainTests;

import org.mili.rnd.rxJava.test.chaining.mediator1.Impl.CallMediator;
import org.mili.rnd.rxJava.test.chaining.mediator1.Impl.LogMediator;
import org.mili.rnd.rxJava.test.chaining.mediator1.MediatorOnSubscriber;
import org.mili.rnd.rxJava.test.chaining.mediator1.MediatorSubscriber;
...
public class test_01_threadTest {
    public static void main(String[] args) {
        ...
        MediatorSubscriber mediatorSubscriberA = new MediatorSubscriber(logMediatorA);
        MediatorSubscriber mediatorSubscriberB = new MediatorSubscriber(callMediatorB);

        callMediatorA.subscribe(mediatorSubscriberA);
        logMediatorA.subscribe(mediatorSubscriberB);
